...
<div class="app">
	...
	<section class="py-32">
		<div class="max-w-sm w-full lg:max-w-xl mx-auto lg:flex justify-center">
			<div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1661127402251-0ef7e3b05a48?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80')" title="Woman holding a mug">
			</div>
